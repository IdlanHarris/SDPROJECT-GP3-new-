            ...
            <div class="row justify-content-center"> <!-- Center the column -->
                <div class="col-lg-6">
                    ...
                    <div class="chart-calculate-form">
                        <p class="text-center">Fill in all the information below to reset your password.</p>
                        <form action="forgot-password.php" method="POST">
                            <div class="row">
                                <div class="col-lg-12">
                                    <input type="text" placeholder="Email" class="form-control" name="Email" required> <!-- Added required attribute -->
                                </div>
                                <div class="col-lg-12 text-center"> <!-- Center the button -->
                                    <button type="submit" class="btn btn-primary">Submit</button> <!-- Added btn class -->
                                </div>
                            </div>
                        </form>
                        <p class="text-muted mt-3 text-center">
                            You have an account? <a href="Login.html">Login here</a>
                        </p> <!-- Updated link -->
                    </div>
                </div>
            </div>
